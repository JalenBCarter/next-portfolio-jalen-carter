...
export const About = () => {
    return (
        <div className="my-[80px]">
            <div className="px-[15px] sm:px-[50px] lg:px-[50px] mx-auto flex flex-col lg:flex-row items-center justify-around text-center md:text-start">
                ...
                <div className="lg:w-[70%] mx-3">
                    ...
                    <div className='text-justify text-gray-500'>
                        My goal as a developer is to leverage my skills to create enjoyable digital experiences
