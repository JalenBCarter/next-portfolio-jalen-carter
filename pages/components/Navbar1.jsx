...
<nav className="fixed w-full top-3 left-0 h-20 z-20">
  <div className="container flex flex-wrap items-center justify-around w-[100%] mx-auto">
    ...
    <div className="hidden w-full md:block md:w-auto shadow-xl" id="navbar-default">
